...
LATEST_INDIA_GDP = ("7.70", "FY26")
LATEST_INDIA_WPI = ("8.30", "Apr 2026")
LATEST_INDIA_CPI = ("3.20", "Apr 2026")
...
if __name__ == "__main__":
    ...
    mr.insert(0, ["India CPI inflation (YoY)", f"{LATEST_INDIA_CPI[0]}% ({LATEST_INDIA_CPI[1]})",
                  '<span class="muted">published figure</span>', "Monthly"])
    mr.insert(1, ["India WPI inflation (YoY)", f"{LATEST_INDIA_WPI[0]}% ({LATEST_INDIA_WPI[1]})",
                  '<span class="muted">published figure</span>', "Monthly"])
    mr.insert(2, ["India GDP Growth", f"{LATEST_INDIA_GDP[0]}% ({LATEST_INDIA_GDP[1]})",
                  '<span class="muted">published figure</span>', "Quarterly / annual"])
    secs.append(("6 . Macro indicators",
                 ["Indicator", "Latest", "Change (YoY)", "Period"], mr))
